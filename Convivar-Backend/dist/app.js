...
const residentService = new ResidentService(residentRepository, residentialComplexRepository);
const financeService = new FinanceService(financeRepository, residentialComplexRepository);
const unitService = new UnitService(financeRepository, residentialComplexRepository);
